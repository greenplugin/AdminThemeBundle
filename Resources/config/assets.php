            ...
            return [
                ...
                'admin_lte_css' => [
                    'inputs' => [
                        ...
                        $jsAssets . 'bower/bower_components/ionicons/docs/css/ionicons.min.css',
                ...
                'admin_lte_fonts' => [
                    'inputs' => [
                        ...
                        $jsAssets . 'bower/bower_components/ionicons/docs/fonts/ionicons.eot',
                        $jsAssets . 'bower/bower_components/ionicons/docs/fonts/ionicons.svg',
                        $jsAssets . 'bower/bower_components/ionicons/docs/fonts/ionicons.ttf',
                        $jsAssets . 'bower/bower_components/ionicons/docs/fonts/ionicons.woff',
                    ],
                ],
                'admin_lte_forms_js' => [
                    'inputs' => [
